...
```bash
# 下载安装脚本
wget https://raw.githubusercontent.com/hookrock/lnmp-panel/main/deploy/install.sh
chmod +x install.sh
...
# 下载二进制文件
cd /opt/lnmp-panel
sudo wget https://github.com/hookrock/lnmp-panel/releases/latest/lnmp-panel-armv7l
...
```bash
# 拉取镜像
docker pull hookrock/lnmp-panel:armv7l
